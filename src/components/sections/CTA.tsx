...
import { Zap, ArrowRight, Blocks } from 'lucide-react'
import './CTA.css'
                ...
                >
                    ...
                    <div className="cta__content">
                        ...
                        <h2 className="cta__title">
                            Ready to Automate on <span className="gradient-text">Algorand</span>?
                        </h2>
                        <p className="cta__subtitle">
                            Join thousands of builders using AlgoZap to automate their
                            Algorand workflows. Free to start, powered by the greenest blockchain.
                        </p>
